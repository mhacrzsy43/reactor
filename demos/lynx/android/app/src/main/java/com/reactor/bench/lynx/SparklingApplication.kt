...
import com.reactor.bench.lynx.LynxInputComponent
import com.reactor.bench.lynx.BuiltinTemplateProvider
...
class SparklingApplication : Application() {
    ...
    override fun onCreate() {
        super.onCreate()
        registerActivityLifecycleCallbacks(LynxAutomationAccessibilityBridge())
        initFresco()
        initSparkling()
    }
